...
#Ti = ChemicalPotential['mu4'].astype(float) - REF['Ti'][0]
#W  = ChemicalPotential['mu5'].astype(float) - REF['W'][0]
mu_Va = ChemicalPotential['VFE'].astype(float)
# --------------------------------------------------------------
# --------------------------------------------------------------
Nb = ChemicalPotential['mu1'][25:124].astype(float) - REF['Nb'][0]
Mo = ChemicalPotential['mu2'][list(range(0,25)) + list(range(50,125))].astype(float) - REF['Mo'][0]
Ta = ChemicalPotential['mu3'][list(range(0,50)) + list(range(75,125))].astype(float) - REF['Ta'][0]
Ti = ChemicalPotential['mu4'][list(range(0,75)) + list(range(100,125))].astype(float) - REF['Ti'][0]
W  = ChemicalPotential['mu5'][0:99].astype(float) - REF['W'][0]
...
plt.title('NbMoTaTiW 125 atom SQS, PBEsol functional')
